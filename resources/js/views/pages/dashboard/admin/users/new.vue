                    ...
                    <div class="bg-white md:grid md:grid-cols-3 md:gap-6 px-4 py-5 sm:p-6">
                        ...
                        <div class="mt-5 md:mt-0 md:col-span-2">
                            <div class="grid grid-cols-3 gap-6">
                                ...
                                <div class="col-span-3">
                                    <label class="block text-sm font-medium leading-5 text-gray-700" for="staffno">{{ $t('Staff Number') }}</label>
                                    <div class="mt-1 relative rounded-md shadow-sm">
                                        <input
                                            id="staffno"
                                ...
                                <div class="col-span-3">
                                    <label class="block text-sm font-medium leading-5 text-gray-700" for="icno">{{ $t('IC Number') }}</label>
                                    <div class="mt-1 relative rounded-md shadow-sm">
                                        <input
                                            id="icno"
                                            v-model="user.icno"
